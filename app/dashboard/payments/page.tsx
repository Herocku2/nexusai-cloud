...
import { DollarSign, ArrowDownCircle, Clock, CheckCircle2 } from "lucide-react";
import { createDepositRequest, getDepositAddress, getPendingDeposits, getPaymentStats, activateMembershipAction } from "@/app/actions/payments";
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  />
                  <CopyButton text={addresses.TRC20} />
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <Input
                    ...
                    className="font-mono text-sm"
                  />
                  <CopyButton text={addresses.ERC20} />
                </div>
                <p className="text-xs text-muted-foreground mt-1">
